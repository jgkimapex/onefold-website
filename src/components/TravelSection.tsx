...
export default function TravelSection() {
    ...
    return (
        <section className="h-screen snap-start snap-always flex flex-col items-center justify-center pt-20 pb-10 px-6 text-center overflow-hidden bg-slate-50/50">
            <div className="max-w-4xl mx-auto flex flex-col gap-6 md:gap-12 items-center w-full">
                ...
                >
                    <span className="text-lg md:text-3xl text-slate-500 font-medium tracking-tight bg-white shadow-sm border border-slate-100 px-6 py-2 md:px-8 md:py-3 rounded-full mb-3 md:mb-6 inline-block [word-break:keep-all]">
                        {t('problem')}
                    </span>
