...
export default function OrganizeSection() {
    ...
    return (
        <section className="h-screen snap-start snap-always flex flex-col items-center justify-center pt-8 md:pt-20 pb-2 md:pb-8 px-6 text-center overflow-hidden">
            <div className="max-w-4xl mx-auto flex flex-col gap-1 md:gap-8 items-center w-full h-full justify-between py-0.5 md:py-4">
                ...
                >
                    <span className="text-base md:text-3xl text-slate-500 font-medium tracking-tight bg-slate-100 px-5 py-1 md:px-8 md:py-3 rounded-full mb-0.5 md:mb-4 inline-block [word-break:keep-all]">
                        {t('problem')}
                    </span>
                ...
                >
                    <button className="w-full sm:w-auto flex items-center justify-center gap-2 md:gap-3 bg-primary text-white px-5 py-2 md:px-8 md:py-4 rounded-xl md:rounded-2xl font-bold text-base md:text-xl hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/20 active:scale-95">
