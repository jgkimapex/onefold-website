...
export default function PrivacySection() {
    ...
    return (
        <section className="min-h-dvh snap-start md:h-screen md:snap-always flex flex-col items-center justify-center pt-20 [@media(max-height:740px)]:pt-16 md:pt-24 pb-10 [@media(max-height:740px)]:pb-6 md:pb-8 px-6 text-center overflow-visible md:overflow-hidden bg-slate-50/30">
            <div className="max-w-4xl mx-auto flex flex-col gap-4 [@media(max-height:740px)]:gap-3 md:gap-8 items-center w-full md:h-full justify-between py-4 [@media(max-height:740px)]:py-2 md:py-4">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-[240px] [@media(max-height:740px)]:max-w-[210px] md:max-w-lg aspect-square md:flex-1 flex items-center justify-center md:min-h-0"
                >
