...
export default function PrivacySection() {
    ...
    return (
        <section className="md:h-screen md:snap-start md:snap-always flex flex-col items-center justify-center pt-20 md:pt-24 pb-10 md:pb-8 px-6 text-center overflow-visible md:overflow-hidden bg-slate-50/30">
            <div className="max-w-4xl mx-auto flex flex-col gap-4 md:gap-8 items-center w-full md:h-full justify-between py-4 md:py-4">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-[240px] md:max-w-lg aspect-square md:flex-1 flex items-center justify-center md:min-h-0"
                >
