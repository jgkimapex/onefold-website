...
export default function Hero() {
    ...
    return (
        <section className="h-screen snap-start snap-always flex flex-col items-center justify-center pt-12 md:pt-20 pb-4 md:pb-8 px-6 text-center overflow-hidden">
